...
namespace Microsoft.AspNetCore.Razor.Language.Syntax
{
  ...
  internal static partial class SyntaxFactory
  {
    ...
    public static MarkupEndTagSyntax MarkupEndTag(SyntaxToken openAngle, SyntaxToken bang, SyntaxToken name, SyntaxList<RazorSyntaxNode> attributes, SyntaxToken closeAngle)
    {
      switch (openAngle.Kind)
      {
        case SyntaxKind.OpenAngle:
      ...
      return (MarkupEndTagSyntax)InternalSyntax.SyntaxFactory.MarkupEndTag((Syntax.InternalSyntax.SyntaxToken)openAngle.Green, (Syntax.InternalSyntax.SyntaxToken)bang.Green, (Syntax.InternalSyntax.SyntaxToken)name.Green, attributes.Node.ToGreenList<InternalSyntax.RazorSyntaxNode>(), (Syntax.InternalSyntax.SyntaxToken)closeAngle.Green).CreateRed();
    }

    /// <summary>Creates a new MarkupEndTagSyntax instance.</summary>
    public static MarkupEndTagSyntax MarkupEndTag(SyntaxList<RazorSyntaxNode> attributes = default(SyntaxList<RazorSyntaxNode>))
    {
      return SyntaxFactory.MarkupEndTag(SyntaxFactory.Token(SyntaxKind.OpenAngle), default(SyntaxToken), SyntaxFactory.Token(SyntaxKind.Text), attributes, SyntaxFactory.Token(SyntaxKind.CloseAngle));
    }
